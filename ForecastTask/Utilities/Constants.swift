...
let ERROR_MSG_UNEXPECTED_ERROR = "We are experiencing a technical issue. Please try again"


// MARK: - Helping Methods

func convertFormula(kelvin: Double) -> Int {
    let celsius = Int(kelvin - 273.15)
    return celsius
}


// for multiple type for single key
enum AnyCodableValue: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        /* if let x = try? container.decodeNil() {
         self = .string("")
         return
         } */
